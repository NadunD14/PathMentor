        ...
        <header className="bg-white py-4 shadow-sm sticky top-0 z-50">
            <div className="container-custom flex justify-between items-center">
                <div className="flex items-center">
                    ...
                    <Link href="/" className="text-xl font-bold text-blue-600 tracking-tight hover:text-blue-700 transition-colors">PathMentor</Link>
                </div>
                <nav className="hidden md:flex items-center space-x-6">
                    <Link href="/user/faq" className="nav-link font-medium">FAQ</Link>
                    <Link href="/user/about" className="nav-link font-medium">About</Link>
                    <Link href="/user/pricing" className="nav-link font-medium">Pricing</Link>
                    <Link href="/user/login" className="nav-link font-medium">Login</Link>
